...
import com.cfw.m1212.web.commons.dto.UploadResult;
import com.cfw.m1212.web.commons.utils.Folder;
...
public class FileUploadController {
	...
	@ResponseBody
	public UploadResult uploadTemp2Files(@RequestParam("file") MultipartFile file){
		UploadResult uploadResult = new UploadResult();
		try{
